...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class TakeCameraScreenshot : FsmStateAction
	{
		...
		public void getPicture()
		{
			...
			RenderTexture rt = new RenderTexture(resWidth.Value, resHeight.Value, Depth,RenderTextureFormat.ARGB32);
			gameObject.Value.GetComponent<Camera>().targetTexture = rt;
			Texture2D screenShot = new Texture2D(resWidth.Value, resHeight.Value, textureFormat, false);
